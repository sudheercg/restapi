...
public class EmployeeRestController {
	 ...
	 * updateEmployee(@PathVariable int employeeId, @RequestBody Employee
	 * theEmployee) { // Check if the employee exists Employee existingEmployee =
	 ...
	 * 
	 * // Save the updated employee return employeeService.save(existingEmployee); }
	 */
